...
import { useReducer } from 'react';
  ...
  export const LoginForm=({onChange,name,data,navigate,location})=> {
    ...
    return (
      <Flex
        ...
        <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
          <Stack align={'center'}>
            <Heading fontSize={'3xl'}>Sign in to your {name} account</Heading>
          ...
          <Box
            ...
            <Stack spacing={4}>
              ...
              <Stack pt={6}>
              <Text align={'center'}>
                Did'nt have a Account? <RLink to="/register" color={'blue.400'}>Register</RLink>
              </Text>
            </Stack>
            </Stack>
          </Box>
